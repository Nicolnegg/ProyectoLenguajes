...
public interface PythonParserVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link PythonParser#inter_compound_stmt}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitInter_compound_stmt(PythonParser.Inter_compound_stmtContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitWhile_stmt(PythonParser.While_stmtContext ctx) throws ScriptException;
	/**
