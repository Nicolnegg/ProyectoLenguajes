...
public class MyGrammarParser extends Parser {
	...
	public static final int
		...
		T__80=81, NAME=82, TYPE_COMMENT=83, AWAIT=84, ASYNC=85, NUMBER=86, STRING=87, 
		ENDMARKER=88, NEWLINE=89, INDENT=90, DEDENT=91;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			null, "'await'", "'async'", null, null, "'<EOF>'"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, null, null, null, null, null, null, null, "NAME", "TYPE_COMMENT", 
			"AWAIT", "ASYNC", "NUMBER", "STRING", "ENDMARKER", "NEWLINE", "INDENT", 
			"DEDENT"
		};
	}
	...
	public final File_inputContext file_input() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 20646543379923990L) != 0) || ((((_la - 68)) & ~0x3f) == 0 && ((1L << (_la - 68)) & 3112627L) != 0)) {
				{
				setState(197);
				_errHandler.sync(this);
				switch (_input.LA(1)) {
	...
	public final DecoratorContext decorator() throws RecognitionException {
		...
		try {
			...
			if (_la==T__1) {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 20266232682908676L) != 0) || ((((_la - 68)) & ~0x3f) == 0 && ((1L << (_la - 68)) & 872115L) != 0)) {
					{
					setState(216);
					arglist();
					}
	...
	public final Return_stmtContext return_stmt() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 20266232682906628L) != 0) || ((((_la - 68)) & ~0x3f) == 0 && ((1L << (_la - 68)) & 872115L) != 0)) {
				{
				setState(826);
				testlist_star_expr();
				}
	...
	public final Raise_stmtContext raise_stmt() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 20266232682905604L) != 0) || ((((_la - 68)) & ~0x3f) == 0 && ((1L << (_la - 68)) & 872115L) != 0)) {
				{
				setState(832);
				test();
				setState(835);
		...
		try {
			...
			case NEWLINE:
				...
				do {
					...
					_errHandler.sync(this);
					_la = _input.LA(1);
				} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 20646543379923990L) != 0) || ((((_la - 68)) & ~0x3f) == 0 && ((1L << (_la - 68)) & 1015475L) != 0) );
				setState(1052);
				match(DEDENT);
				}
				break;
	...
	public final Yield_exprContext yield_expr() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 20266236977873924L) != 0) || ((((_la - 68)) & ~0x3f) == 0 && ((1L << (_la - 68)) & 872115L) != 0)) {
				{
				setState(1439);
				yield_arg();
				}
